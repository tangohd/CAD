...
<title>WMRPC - <?php echo $unitInfo['unit']; ?></title>
		...
		<div class="row">.
			...
			<div class="col-sm-12 col-md-10 col-lg-10">
				<div class="alert state<?php echo $unitInfo['status'];?> text-center">
					<b>Current Status: State <?php echo $unitInfo['status']; ?></b>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
			...
			<div class="card custom-card">
				...
				<div class="card-body">
					...
					if(isset($_POST['makePanic'])) {
						updateUnitStatus($unitInfo['unitid'], '0');
					}
					...
					<div class="row">
						<div class="form-group col-sm-12 col-md-6 col-lg-4">
        	   			...
        	   			<div class="form-group col-sm-12 col-md-6 col-lg-4">
    	            		<input type="submit" name='makeUnavailable' class="btn state4 btn-green btn-block" value="Unavailable">
        	   			</div>
        	   			<div class="form-group col-sm-12 col-md-6 col-lg-4">
        	        		<input type="submit" name='makeOnRoute' class="btn state5 btn-green btn-block" value="On Route">
        	   			</div>
        	   			<div class="form-group col-sm-12 col-md-6 col-lg-4">
        	        		<input type="submit" name='makeOnScene' class="btn state6 btn-green btn-block" value="On Scene">
        	   			</div>
        	   			<div class="form-group col-sm-12 col-md-6 col-lg-4">
        	        		<input type="submit" name='makeCommitted' class="btn state12 btn-green btn-block" value="Committed">
        	   			</div>
        	   			<div class="form-group col-sm-12 col-md-6 col-lg-4">
        	        		<input type="submit" name='makeTransport' class="btn state9 btn-green btn-block" value="Transport">
        	   			</div>
        	   			<div class="form-group col-sm-12 col-md-6">
        	        		<input type="submit" name='makePanic' class="btn state0 btn-green btn-block" value="Panic">
        	   			</div>
        	   			<div class="form-group col-sm-12 col-md-6">
        	        		<input type="submit" name='signOff' class="btn state11 btn-green btn-block" value="Book Off">
        	   			</div>
        	   		</div>
        	   		</form>
				</div>
      				...
      				<div class="container">
						...
						<?php
							if(isset($_POST['sendMessage'])) { 
			  	  				sendMessage('CONTROL', strtoupper($unitInfo['unit']), $_POST['message']);
							}
						?> 
					</div>
      			</div>
