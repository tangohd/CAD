...
<title>WMRPC - Manage Vehicles of Interest</title>
		...
		<div class="col-md-3">
			<div class="card custom-card">
				...
				<div class="card-body">
                    ...
                    ?>
                    <div class="alert alert-success"><b>VOI Created</b> This voi has been created and is ready for use.</div>
                    <?php
						}
					?>
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group col-md-12">
  						...
  						<div class="form-group col-md-12">
							<input type="submit" name='createVoi' class="btn btn-success btn-block" value="Create POI">
						</div>
					</form>
				</div>
			</div>
