...
<div class="container" style="margin-top: 25px;">
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header"><a class="text-dark" href="./intel-cad-reports.php"><i class="fa fa-undo"></i></a> View CAD Report: <?php echo $reportInfo['cad']; ?></div>
				<div class="card-body">
