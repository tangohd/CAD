...
<title>WMRPC - Manage Civilians</title>
		...
		<div class="col-md-3">
			<div class="card custom-card">
				...
				<div class="card-body">
                    ...
                    ?>
                    <div class="alert alert-success"><b>Civilian Created</b> This civ has been created and is ready for use.</div>
                    <?php
						}
					?>
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group col-md-12">
  						...
  						<div class="form-group" style="width: 100%;">
							<input type="submit" name='createCiv' class="btn btn-success btn-block" value="Create Civ">
						</div>
					</form>
				</div>
			</div>
