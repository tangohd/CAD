				...
				<ul class="m1-1 navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item" href="./control-operator.php">Operator</a>
							<?php
								$permCheck = haveGeneralPerm($UserArray['userid'], 4);
								if($permCheck == true){
							?>
							<a class="dropdown-item" href="./control-dispatcher.php">Dispatcher</a>
							<?php
								}
							?>
							<?php
								...
								if($permCheck == true){
							?>
							<a class="dropdown-item" href="./control-tacad.php">Tactical Advisor</a>
							<?php
								}
							?>
							<a class="dropdown-item" href="./pnc-check-search.php">PNC Checks</a>
							<a class="dropdown-item" href="./vrm-check-search.php">VRM Checks</a>
							<a class="dropdown-item" href="./phone999.php">Create a Log</a>
						</div>
					</li>
					<?php
						}
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item" href="./intel-cad-reports.php">Log Report</a>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item" href="./signOn.php">Book On</a>
							<a class="dropdown-item" href="./cad-reports.php">Submit a Report</a>
						</div>
					</li>
					<?php
						}
