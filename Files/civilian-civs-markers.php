...
<title>WMRPC - Edit Civilian Markers: <?php echo $civInfo['name']; ?></title>
        ...
        <div class="col-md-8">
            <div class="card custom-card">
                <div class="card-header">
                    Edit Civilian Markers: <?php echo $civInfo['name']; ?>
                </div>
                <div class="card-body">
                    <?php
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?cid=<?php echo $civInfo['civid']; ?>" method="post">
                        ...
                        <div class="form-group" style="width: 100%;">
                            <input type="submit" name='updateAllowed' class="btn btn-success btn-block" value="Update Markers">
                        </div>
                    </form>
                </div>
            </div>
