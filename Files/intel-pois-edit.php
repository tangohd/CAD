...
<title>WMRPC - Edit Poi: <?php echo $civInfo['name']; ?></title>
		...
		<div class="col-md-6">
			<div class="card custom-card">
				<div class="card-header">
					Edit POI: <?php echo $civInfo['name']; ?>
				</div>
				<div class="card-body">
					<?php
          ...
          ?>
                    <div class="alert alert-success"><b>POI Updated</b> The POI has been updated.</div>
          <?php
						}
					?>
          <?php
            if(isset($_POST['clearPoi'])) { 
              clearPoi($_GET['poi']);
          ?>
                    <div class="alert alert-danger"><b>POI Cleared</b> The POI has been cleared.</div>
          <?php
          ...
          ?>
					<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?poi=<?php echo $poiInfo['id']; ?>" method="post">
                        ...
                        <div class="form-group col-md-12">
                            <input type="submit" name='updatePoi' class="btn btn-success btn-block" value="Update POI Record">
                        </div>
                        <div class="form-group col-md-12">
                            <input type="submit" name='clearPoi' class="btn btn-danger btn-block" value="Clear POI">
                        </div>
                      </div>
					</form>