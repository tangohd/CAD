...
<title>WMRPC - Manage Users</title>
			...
			<div class="card custom-card">
				...
				<table class="table table-responsive-xl" id="refreshDiv">
                  ...
                  if(memberOfGroup($user['userid'],14) == false || (memberOfGroup($user['userid'],14) == true && memberOfGroup($UserArray['userid'],14) == true)){
	  					?>
    					<tr <?php if(haveGeneralPerm($user['userid'], 1) == false){ ?> class="state4" <?php }elseif(memberOfGroup($user['userid'],14) == true){ ?> class="state0" <?php }else{ ?> class="state2" <?php } ?>>
